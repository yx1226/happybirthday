window.ConfettiGenerator=function(e){
	function t(e,t){e||(e=1);var i=Math.random()*e;
	...
	function r(e){
		var t=e.radius<=3?.4:.8;switch(n.fillStyle=n.strokeStyle="rgba("+e.color+", "+t+")",n.beginPath(),e.prop){
			case"circle":
	...
	var a={
		target:"confetti-holder",max:80,size:1,animate:!0,props:["circle","square","triangle","line"],
